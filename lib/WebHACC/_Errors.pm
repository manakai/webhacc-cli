$WebHACC::_Errors = {
          ...
          "event handler" => {
                               ...
                               "message" => {
                                              ...
                                              "ja" => "\x{30a4}\x{30d9}\x{30f3}\x{30c8}\x{30cf}\x{30f3}\x{30c9}\x{30e9}\x{30fc}\x{5c5e}\x{6027}\x{306e}\x{59a5}\x{5f53}\x{6027}\x{691c}\x{8a3c}\x{306f}\x{672a}\x{5bfe}\x{5fdc}\x{3067}\x{3059}"
                                            },
                               "targets" => {
                                              "attr" => 1
                                            }
