$WebHACC::_Errors = {
          ...
          "IMT:composite" => {
                             "desc" => {
                                       "en" => "\n    <p>A composite MIME type (<code>message/<var>*</var></code> and\n    <code>multipart/<var>*</var></code>) cannot be embedded in an Atom\n    element.</p>\n  ",
                                       "ja" => "\n    <p>\x{5408}\x{6210} MIME \x{578b} (<code>message/<var>*</var></code> and\n    <code>multipart/<var>*</var></code>) \x{3092} Atom \x{8981}\x{7d20}\x{5185}\x{306b}\x{57cb}\x{3081}\x{8fbc}\x{3080}\x{3053}\x{3068}\x{306f}\x{3067}\x{304d}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n  "
                                     },
                             "message" => {
                                          "en" => "The MIME type is a composite type",
                                          "ja" => "\x{3053}\x{306e} MIME \x{578b}\x{306f}\x{5408}\x{6210}\x{578b}\x{3067}\x{3059}"
                                        }
                           },
          ...
          "OGP locale:bad value" => {
                                    "desc" => {
                                              "en" => "\n    <p>The value must be a locale identifier in OGP, i.e. a language\n    code (lowercase), followed by a <code>_</code> character, followed\n    by a country code (uppercase).  This is not equal to a BCP 47\n    language tag.</p>\n  ",
                                              "ja" => "\n    <p>\x{5024}\x{306f} OGP \x{306e}\x{30ed}\x{30b1}\x{30fc}\x{30eb}\x{8b58}\x{5225}\x{5b50} (\x{8a00}\x{8a9e}\x{7b26}\x{53f7} (\x{5c0f}\x{6587}\x{5b57}) \x{306e}\x{3042}\x{3068}\x{306b}\n    <code>_</code> \x{306e}\x{3042}\x{3068}\x{306b}\x{56fd}\x{7b26}\x{53f7} (\x{5927}\x{6587}\x{5b57})) \x{3067}\x{306a}\x{3051}\x{308c}\x{306a}\x{3044}\x{3051}\x{307e}\x{305b}\x{3093}\x{3002}\n    \x{3053}\x{308c}\x{306f} BCP 47 \x{8a00}\x{8a9e}\x{30bf}\x{30b0}\x{3068}\x{306f}\x{9055}\x{3044}\x{307e}\x{3059}\x{3002}</p>\n  "
                                            },
                                    "message" => {
                                                 "en" => "The value is not an OGP locale",
                                                 "ja" => "\x{3053}\x{308c}\x{306f} OGP \x{30ed}\x{30b1}\x{30fc}\x{30eb}\x{5024}\x{3067}\x{306f}\x{3042}\x{308a}\x{307e}\x{305b}\x{3093}"
                                               }
                                  },
          "OGP unit:bad value" => {
                                  "desc" => {
                                            "en" => "\n    <p>The value must be one of units defined in OGP.</p>\n  ",
                                            "ja" => "\n    <p>\x{5024}\x{306f} OGP \x{3067}\x{5b9a}\x{7fa9}\x{3055}\x{308c}\x{3066}\x{3044}\x{308b}\x{5358}\x{4f4d}\x{306e}\x{3044}\x{305a}\x{308c}\x{304b}\x{3067}\x{306a}\x{3051}\x{308c}\x{3070}\x{3044}\x{3051}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n  "
                                          },
                                  "message" => {
                                               "en" => "The value is not a unit for OGP",
                                               "ja" => "\x{3053}\x{306e}\x{5024}\x{306f} OGP \x{306e}\x{5358}\x{4f4d}\x{3067}\x{306f}\x{3042}\x{308a}\x{307e}\x{305b}\x{3093}"
                                             }
                                },
          ...
          "aria:not preferred markup:html-attr" => {
                                                   ...
                                                   "message" => {
                                                                "en" => "<code><var>{text}</var></code> \x{5c5e}\x{6027}\x{306e}\x{65b9}\x{304c}\x{9069}\x{5207}\x{3067}\x{3059}"
                                                              },
                                                   "targets" => {
                                                                "attr" => 1
                                                              }
          ...
          "attribute not allowed:dialog tabindex" => {
                                                     "desc" => {
                                                               "en" => "\n    <p>The <code>tabindex</code> attribute cannot be specified for\n    an HTML <code>dialog</code> element as it is redudant or\n    conflcts with the element's emantics.</p>\n  ",
                                                               "ja" => "\n    <p>HTML <code>dialog</code> \x{8981}\x{7d20}\x{306e} <code>tabindex</code> \n    \x{5c5e}\x{6027}\x{306f}\x{3001}\x{5197}\x{9577}\x{3067}\x{3042}\x{308b}\x{304b}\x{8981}\x{7d20}\x{306e}\x{610f}\x{5473}\x{3067}\x{77db}\x{76fe}\x{3057}\x{3066}\x{3057}\x{307e}\x{3046}\x{306e}\x{3067}\x{3001}\n    \x{6307}\x{5b9a}\x{3067}\x{304d}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n  "
                                                             },
                                                     "message" => {
                                                                  "en" => "A <code>tabindex</code> attribute is specified\n  for a <code>dialog</code> element",
                                                                  "ja" => "<code>dialog</code> \x{8981}\x{7d20}\x{306b}\n  <code>tabindex</code> \x{5c5e}\x{6027}\x{304c}\x{6307}\x{5b9a}\x{3055}\x{308c}\x{3066}\x{3044}\x{307e}\x{3059}"
                                                                },
                                                     "targets" => {
                                                                  "attr" => 1
                                                                }
          ...
          "bare pero" => {
                         "desc" => {
                                   "en" => "\n    <p>After the <code>%</code> character, there must be a name of the\n    parameter entity to be referenced, followed by a <code>;</code>\n    character.</p>\n  ",
                                   "ja" => "\n    <p>\x{6587}\x{5b57} <code>%</code> \x{306e}\x{5f8c}\x{306b}\x{306f}\x{53c2}\x{7167}\x{3059}\x{308b}\x{5f15}\x{6570}\x{5b9f}\x{4f53}\x{306e}\x{540d}\x{524d}\x{3068}\x{6587}\x{5b57}\n    <code>;</code> \x{304c}\x{5fc5}\x{8981}\x{3067}\x{3059}\x{3002}</p>\n  "
                                 },
                         "message" => {
                                      "en" => "The <code>%</code> character is not followed\n  by a parameter entity name",
          ...
          "character not allowed:a heading" => {
                                               "desc" => {
                                                         "en" => "\n    <p>The content of a <code>summary</code> element must be either\n    phrasing content or a heading content.  If a\n    <code>h<var>n</var></code> element is used in the element, no\n    other element or non-space text can be used.</p>\n  ",
                                                         "ja" => "\n    <p><code>summary</code> \x{8981}\x{7d20}\x{306e}\x{5185}\x{5bb9}\x{306f}\x{8a9e}\x{53e5}\x{5185}\x{5bb9}\x{304b}\x{3001}\n    \x{898b}\x{51fa}\x{3057}\x{5185}\x{5bb9}1\x{3064}\x{3067}\x{306a}\x{3051}\x{308c}\x{3070}\x{3044}\x{3051}\x{307e}\x{305b}\x{3093}\x{3002} <code>summary</code>\n    \x{8981}\x{7d20}\x{306e}\x{4e2d}\x{306b} <code>h<var>n</var></code> \x{8981}\x{7d20}\x{304c}\x{3042}\x{308b}\x{6642}\x{306f}\x{3001}\n    \x{305d}\x{308c}\x{4ee5}\x{5916}\x{306e}\x{8981}\x{7d20}\x{3084}\x{7a7a}\x{767d}\x{3067}\x{306a}\x{3044}\x{6587}\x{5b57}\x{3092}\x{542b}\x{3081}\x{3066}\x{306f}\x{3044}\x{3051}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n  "
                                                       },
                                               "message" => {
                                                            "en" => "A non-space character is used in a\n  <code>summary</code> with a heading content",
                                                            "ja" => "\x{898b}\x{51fa}\x{3057}\x{304c}\x{542b}\x{307e}\x{308c}\x{308b} <code>summary</code>\n  \x{5185}\x{306b}\x{7a7a}\x{767d}\x{4ee5}\x{5916}\x{306e}\x{6587}\x{5b57}\x{304c}\x{3042}\x{308a}\x{307e}\x{3059}"
                                                          }
                                             },
          ...
          "character not allowed:atom|TextConstruct" => {
                                                        "desc" => {
                                                                  "en" => "\n    <p>In an Atom Text construct or <code>content</code> element whose\n    <code>type</code> is <code>xhtml</code> or an XML MIME type, text\n    other than space characters is not allowed.</p>\n  ",
                                                                  "ja" => "\n    <p>Atom Text \x{69cb}\x{9020}\x{8981}\x{7d20}\x{3084} <code>content</code> \x{8981}\x{7d20}\x{306e}\n    <code>type</code> \x{5c5e}\x{6027}\x{5024}\x{304c} <code>xhtml</code> \x{3084} XML MIME\n    \x{578b}\x{306e}\x{6642}\x{306f}\x{7a7a}\x{767d}\x{6587}\x{5b57}\x{4ee5}\x{5916}\x{306e}\x{30c6}\x{30ad}\x{30b9}\x{30c8}\x{306f}\x{4f7f}\x{3048}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n  "
                                                                },
                                                        "message" => {
          ...
          "child element missing:app" => {
                                         "desc" => {
                                                   "en" => "\n    <p>The element must contain a child element with the specified\n    local name in the AtomPub namespace\n    (<code>http://www.w3.org/2007/app</code>).</p>\n  ",
                                                   "ja" => "\n    <p>\x{3053}\x{306e}\x{8981}\x{7d20}\x{306f}\x{5b50}\x{8981}\x{7d20}\x{3068}\x{3057}\x{3066}  Atompub \x{540d}\x{524d}\x{7a7a}\x{9593}\n    (<code>http://www.w3.org/2007/app</code>)\n    \x{306e}\x{7279}\x{5b9a}\x{306e}\x{5c40}\x{6240}\x{540d}\x{306e}\x{8981}\x{7d20}\x{304c}\x{5fc5}\x{8981}\x{3067}\x{3059}\x{3002}</p>\n  "
                                                 },
                                         "message" => {
                                                      "en" => "There is no child AtomPub\n  <code><var>{text}</var></code> element",
                                                      "ja" => "AtomPub\n  <code><var>{text}</var></code> \x{8981}\x{7d20}\x{304c}\x{5b50}\x{8981}\x{7d20}\x{3068}\x{3057}\x{3066}\x{3042}\x{308a}\x{307e}\x{305b}\x{3093}"
                                                    }
                                       },
          "child element missing:atom" => {
                                          "desc" => {
                                                    "en" => "\n    <p>The element must contain a child element with the specified\n    local name in the Atom namespace\n    (<code>http://www.w3.org/2005/Atom</code>).</p>\n  ",
                                                    "ja" => "\n    <p>\x{3053}\x{306e}\x{8981}\x{7d20}\x{306f}\x{5b50}\x{8981}\x{7d20}\x{3068}\x{3057}\x{3066}  Atom \x{540d}\x{524d}\x{7a7a}\x{9593}\n    (<code>http://www.w3.org/2005/Atom</code>) \x{306e}\x{7279}\x{5b9a}\x{306e}\x{5c40}\x{6240}\x{540d}\x{306e}\x{8981}\x{7d20}\x{304c}\x{5fc5}\x{8981}\x{3067}\x{3059}\x{3002}</p>\n  "
                                                  },
                                          "message" => {
                                                       "en" => "There is no child Atom\n  <code><var>{text}</var></code> element",
                                                       "ja" => "Atom\n  <code><var>{text}</var></code> \x{8981}\x{7d20}\x{304c}\x{5b50}\x{8981}\x{7d20}\x{3068}\x{3057}\x{3066}\x{3042}\x{308a}\x{307e}\x{305b}\x{3093}"
                                                     }
                                        },
          "child element missing:atom:link:alternate" => {
                                                         "desc" => {
                                                                   "en" => "\n    <p>An <code>atom:entry</code> or <code>atom:feed</code> element\n    must contain an Atom <code>link</code> element whose\n    <code>rel</code> attribute value is <code>alternate</code>.</p>\n  ",
                                                                   "ja" => "\n    <p><code>atom:entry</code> \x{8981}\x{7d20}\x{3084} <code>atom:feed</code>\n    \x{8981}\x{7d20}\x{306e}\x{5b50}\x{8981}\x{7d20}\x{3068}\x{3057}\x{3066} Atom\n    <code>link</code> \x{8981}\x{7d20}\x{3067} <code>rel</code> \x{5c5e}\x{6027}\x{5024}\x{304c}\n    <code>alternate</code> \x{3067}\x{3042}\x{308b}\x{3082}\x{306e}\x{304c}\x{5fc5}\x{8981}\x{3067}\x{3059}\x{3002}</p>\n  "
                                                                 },
                                                         "message" => {
                                                                      "en" => "There is no child\n  <code>&lt;atom:link rel=alternate&gt;</code> element",
                                                                      "ja" => "\x{5b50}\x{8981}\x{7d20} <code>&lt;atom:link rel=alternate&gt;</code>\n  \x{304c}\x{3042}\x{308a}\x{307e}\x{305b}\x{3093}"
                                                                    }
                                                       },
          "child element missing:atom:link:self" => {
                                                    "desc" => {
                                                              "en" => "\n    <p>An <code>atom:feed</code> element should contain an Atom\n    <code>link</code> element whose <code>rel</code> attribute value\n    is <code>self</code>.</p>\n  ",
                                                              "ja" => "\n    <p><code>atom:feed</code> \x{8981}\x{7d20}\x{306e}\x{5b50}\x{8981}\x{7d20}\x{3068}\x{3057}\x{3066} Atom\n    <code>link</code> \x{8981}\x{7d20}\x{3067} <code>rel</code> \x{5c5e}\x{6027}\x{5024}\x{304c}\n    <code>should</code> \x{3067}\x{3042}\x{308b}\x{3082}\x{306e}\x{304c}\x{542b}\x{307e}\x{308c}\x{3066}\x{3044}\x{308b}\x{3079}\x{304d}\x{3067}\x{3059}\x{3002}</p>\n  "
                                                            },
                                                    "message" => {
                                                                 "en" => "There is no child\n  <code>&lt;atom:link rel=self&gt;</code> element",
                                                                 "ja" => "\x{5b50}\x{8981}\x{7d20} <code>&lt;atom:link rel=self&gt;</code>\n  \x{304c}\x{3042}\x{308a}\x{307e}\x{305b}\x{3093}"
                                                               }
                                                  },
          ...
          "element after entry" => {
                                   "desc" => {
                                             "en" => "\n    <p>In an Atom <code>feed</code> element, <code>atom:entry</code>\n    elements must be inserted after any other element.</p>\n  ",
                                             "ja" => "\n    <p>Atom <code>feed</code> \x{8981}\x{7d20}\x{4e2d}\x{3067} <code>atom:entry</code>\n    \x{8981}\x{7d20}\x{306f}\x{4ed6}\x{306e}\x{8981}\x{7d20}\x{306e}\x{5f8c}\x{306b}\x{306a}\x{3051}\x{308c}\x{3070}\x{3044}\x{3051}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n  "
                                           },
                                   "message" => {
                                                "en" => "There is an <code>atom:entry</code> element\n  before this element",
                                                "ja" => "\x{3053}\x{306e}\x{8981}\x{7d20}\x{306e}\x{524d}\x{306b} <code>atom:entry</code>\n  \x{8981}\x{7d20}\x{304c}\x{3042}\x{308a}\x{307e}\x{3057}\x{305f}"
                                              }
                                 },
          "element missing" => {
                               "desc" => {
          ...
          "element not allowed:a heading" => {
                                             "desc" => {
                                                       "en" => "\n    <p>The content of a <code>summary</code> element must be either\n    phrasing content or a heading content.  If a\n    <code>h<var>n</var></code> element is used in the element, no\n    other element or non-space text can be used.</p>\n  ",
                                                       "ja" => "\n    <p><code>summary</code> \x{8981}\x{7d20}\x{306e}\x{5185}\x{5bb9}\x{306f}\x{8a9e}\x{53e5}\x{5185}\x{5bb9}\x{304b}\x{3001}\n    \x{898b}\x{51fa}\x{3057}\x{5185}\x{5bb9}1\x{3064}\x{3067}\x{306a}\x{3051}\x{308c}\x{3070}\x{3044}\x{3051}\x{307e}\x{305b}\x{3093}\x{3002} <code>summary</code>\n    \x{8981}\x{7d20}\x{306e}\x{4e2d}\x{306b} <code>h<var>n</var></code> \x{8981}\x{7d20}\x{304c}\x{3042}\x{308b}\x{6642}\x{306f}\x{3001}\n    \x{305d}\x{308c}\x{4ee5}\x{5916}\x{306e}\x{8981}\x{7d20}\x{3084}\x{7a7a}\x{767d}\x{3067}\x{306a}\x{3044}\x{6587}\x{5b57}\x{3092}\x{542b}\x{3081}\x{3066}\x{306f}\x{3044}\x{3051}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n  "
                                                     },
                                             "message" => {
                                                          "en" => "More than a heading content element is used\n  in a <code>summary</code>",
                                                          "ja" => "<code>summary</code> \x{5185}\x{306b}\x{898b}\x{51fa}\x{3057}\x{5185}\x{5bb9}\x{8981}\x{7d20}1\x{3064}\x{4ee5}\x{5916}\x{306e}\x{8981}\x{7d20}\x{304c}\x{3042}\x{308a}\x{307e}\x{3059}"
                                                        }
                                           },
          ...
          "element not allowed:atom|TextConstruct" => {
                                                      "desc" => {
                                                                "en" => "\n    <p>Child elements are not allowed in an Atom Text construct or\n    <code>content</code> element, except when the <code>type</code>\n    attribute value is <code>xhtml</code>, in which case only an HTML\n    <code>div</code> element is allowed.</p>\n\n    <p>If the <code>type</code> attribute value is <code>html</code>,\n    any tag in the HTML fragment must be escaped.</p>\n  ",
                                                                "ja" => "\n    <p>Atom Text \x{69cb}\x{9020}\x{8981}\x{7d20}\x{3084} <code>content</code>\n    \x{8981}\x{7d20}\x{3067}\x{306f}\x{5b50}\x{8981}\x{7d20}\x{306f}\x{539f}\x{5247}\x{3068}\x{3057}\x{3066}\x{4f7f}\x{3048}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n\n    <p><code>type</code> \x{5c5e}\x{6027}\x{5024}\x{304c} <code>html</code>\n    \x{306e}\x{3068}\x{304d}\x{306f}\x{3001} HTML \x{7d20}\x{7247}\x{4e2d}\x{306e}\x{30bf}\x{30b0}\x{306f}\x{30a8}\x{30b9}\x{30b1}\x{30fc}\x{30d7}\x{3057}\x{306a}\x{3051}\x{308c}\x{3070}\x{3044}\x{3051}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n\n    <p><code>type</code> \x{5c5e}\x{6027}\x{5024}\x{304c} <code>xhtml</code>\n    \x{306e}\x{3068}\x{304d}\x{306f}\x{3001} HTML <code>div</code> \x{8981}\x{7d20}\x{3092}1\x{3064}\x{3060}\x{3051}\x{4f7f}\x{3048}\x{307e}\x{3059}\x{3002}</p>\n  "
                                                              },
                                                      "message" => {
                                                                   "en" => "The element is not allowed here",
                                                                   "ja" => "\x{3053}\x{306e}\x{8981}\x{7d20}\x{306f}\x{3053}\x{3053}\x{3067}\x{306f}\x{8a8d}\x{3081}\x{3089}\x{308c}\x{3066}\x{3044}\x{307e}\x{305b}\x{3093}"
                                                                 }
                                                    },
          ...
          "element not allowed:atom|link rel=alternate" => {
                                                           "desc" => {
                                                                     "en" => "\n    <p>In an element, there must not be multiple\n    <code>atom:link</code> elements with <code>rel</code> attribute\n    value <code>alternate</code> unless its <code>type</code> and/or\n    <code>hreflang</code> attribute values are different.</p>\n  ",
                                                                     "ja" => "\n    <p>\x{3042}\x{308b}\x{8981}\x{7d20}\x{306e}\x{5b50}\x{4f9b}\x{3067} <code>atom:link</code> \x{8981}\x{7d20}\x{306e}\n    <code>rel</code> \x{5c5e}\x{6027}\x{304c} <code>alternate</code> \x{3067}\x{3042}\x{308b}\x{3082}\x{306e}\x{306f}\x{3001}\n    <code>type</code> \x{3068} <code>hreflang</code>\n    \x{306e}\x{5024}\x{306e}\x{7d44}\x{307f}\x{5408}\x{308f}\x{305b}\x{304c}\x{540c}\x{3058}\x{3067}\x{3042}\x{3063}\x{3066}\x{306f}\x{3044}\x{3051}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n  "
                                                                   },
                                                           "message" => {
                                                                        "en" => "There is an <code>&lt;atom:link rel=alternate&gt;</code>\n  element with same <code>type</code> and <code>hreflang</code>",
                                                                        "ja" => "<code>&lt;atom:link rel=alternate&gt;</code>\n  \x{8981}\x{7d20}\x{3067} <code>type</code> \x{3068} <code>hreflang</code>\n  \x{306e}\x{7d44}\x{307f}\x{5408}\x{308f}\x{305b}\x{304c}\x{540c}\x{3058}\x{3082}\x{306e}\x{304c}\x{4ed6}\x{306b}\x{3082}\x{3042}\x{308a}\x{307e}\x{3059}"
                                                                      }
                                                         },
          ...
          "element not allowed:duplicate" => {
                                             "desc" => {
                                                       ...
                                                       "ja" => "\n    <p>\x{3053}\x{306e}\x{8981}\x{7d20}\x{306f}\x{3001}\x{3053}\x{306e}\x{8981}\x{7d20}\x{306e}\x{89aa}\x{306b}\x{5bfe}\x{3059}\x{308b}\x{5b50}\x{8981}\x{7d20}\x{3068}\x{3057}\x{3066}\x{306f}\x{4e00}\x{5ea6}\x{3057}\x{304b}\x{4f7f}\x{3048}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n  "
                                                     },
                                             "message" => {
                                                          "en" => "There is a sibling element with same\n  local name",
                                                          "ja" => "\x{540c}\x{3058}\x{8981}\x{7d20}\x{540d}\x{306e}\x{5144}\x{5f1f}\x{8981}\x{7d20}\x{304c}\x{3042}\x{308a}\x{307e}\x{3059}"
                                                        }
                                           },
          "element not allowed:empty" => {
                                         "desc" => {
                                                   "en" => "\n    <p>The content model of the parent element is empty such that\n    the element is not allowed.</p>\n\n    <dl class=\"switch\">\n\n    <dt>Atom <code>atom:content</code> element</dt>\n\n    <dd>If a <code>src</code> attribute is specified, no child element\n    is allowed.</dd>\n\n    <dt>AtomPub <code>app:categories</code> element</dt>\n\n    <dd>If an <code>href</code> attribute is specified, no child\n    element is allowed.</dd>\n\n    </dl>\n  ",
                                                   "ja" => "\n    <p>\x{89aa}\x{8981}\x{7d20}\x{306e}\x{5185}\x{5bb9}\x{30e2}\x{30c7}\x{30eb}\x{304c}\x{7a7a}\x{306a}\x{306e}\x{3067}\x{3001}\x{3053}\x{306e}\x{8981}\x{7d20}\x{306f}\x{8a8d}\x{3081}\x{3089}\x{308c}\x{3066}\x{3044}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n\n    <dl class=\"switch\">\n\n    <dt>Atom <code>atom:content</code> \x{8981}\x{7d20}</dt>\n\n    <dd><code>src</code> \x{5c5e}\x{6027}\x{304c}\x{3042}\x{308b}\x{3068}\x{5b50}\x{8981}\x{7d20}\x{3092}\x{542b}\x{3081}\x{3066}\x{306f}\x{3044}\x{3051}\x{307e}\x{305b}\x{3093}\x{3002}</dd>\n\n    <dt>AtomPub <code>app:categories</code> \x{8981}\x{7d20}</dt>\n\n    <dd><code>href</code> \x{5c5e}\x{6027}\x{304c}\x{3042}\x{308b}\x{3068}\x{5b50}\x{8981}\x{7d20}\x{3092}\x{542b}\x{3081}\x{3066}\x{306f}\x{3044}\x{3051}\x{307e}\x{305b}\x{3093}\x{3002}</dd>\n\n    </dl>\n  "
                                                 },
                                         "message" => {
          ...
          "empty itemprop" => {
                              "desc" => {
                                        "en" => "\n    <p>The <code>itemprop</code> attribute must contain one or more\n    property names.</p>\n  ",
                                        "ja" => "\n    <p><code>itemprop</code> \x{5c5e}\x{6027}\x{306b}\x{306f}\x{7279}\x{6027}\x{540d}\x{304c}\x{542b}\x{307e}\x{308c}\x{3066}\x{3044}\x{306a}\x{3051}\x{308c}\x{3070}\x{3044}\x{3051}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n  "
                                      },
                              "message" => {
                                           "en" => "The attribute value is empty",
                                           "ja" => "\x{5c5e}\x{6027}\x{5024}\x{304c}\x{7a7a}\x{3067}\x{3059}"
          ...
          "js:parse error" => {
                              "desc" => {
                                        ...
                                        "ja" => "\n    <p>JavaScript \x{306e}\x{30b3}\x{30fc}\x{30c9}\x{7247}\x{306e}\x{69cb}\x{6587}\x{89e3}\x{6790}\x{4e2d}\x{306b}\x{30a8}\x{30e9}\x{30fc}\x{304c}\x{691c}\x{51fa}\x{3055}\x{308c}\x{307e}\x{3057}\x{305f}\x{3002}</p>\n  "
                                      },
                              "message" => {
                                           "en" => "JavaScript parse error: <code><var>{text}</var></code>",
          ...
          "nninteger:syntax error" => {
                                      "desc" => {
                                                "en" => "\n    <p>The attribute value must be a non-negative integer.</p>\n\n    <p>Decimal marks, signs, and thousands separators are not allowed.\n    Leading and trailing white spaces, as well as units, are not\n    allowed.</p>\n\n    <dl class=\"switch\">\n\n    <dt>HTML <code>width</code> and <code>height</code> attributes</dt>\n\n    <!-- <table width=100%> -->\n    <dd>These attributes cannot be used to specify the rendered\n    dimension of the element.  Use CSS instead.</dd>\n\n    </dl>\n  ",
                                                "ja" => "\n    <p>\x{5c5e}\x{6027}\x{5024}\x{306f}\x{975e}\x{8ca0}\x{6574}\x{6570}\x{3067}\x{306a}\x{3051}\x{308c}\x{3070}\x{3044}\x{3051}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n\n    <p>\x{5c0f}\x{6570}\x{70b9}\x{3001}\x{7b26}\x{53f7}\x{3001}\x{6841}\x{533a}\x{5207}\x{308a}\x{306e}\x{30b3}\x{30f3}\x{30de}\x{306f}\x{4f7f}\x{3048}\x{307e}\x{305b}\x{3093}\x{3002}\n    \x{524d}\x{5f8c}\x{306b}\x{7a7a}\x{767d}\x{3084}\x{5358}\x{4f4d}\x{3092}\x{3064}\x{3051}\x{3066}\x{3082}\x{3044}\x{3051}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n\n    <dl class=\"switch\">\n\n    <dt>HTML <code>width</code> \x{5c5e}\x{6027}\x{3001} <code>height</code> \x{5c5e}\x{6027}</dt>\n\n    <!-- <table width=100%> -->\n    <dd>\x{4e21}\x{5c5e}\x{6027}\x{306f}\x{8981}\x{7d20}\x{3092}\x{30ec}\x{30f3}\x{30c0}\x{30ea}\x{30f3}\x{30b0}\x{3059}\x{308b}\x{5927}\x{304d}\x{3055}\x{306e}\x{6307}\x{5b9a}\x{306b}\x{306f}\x{4f7f}\x{3048}\x{307e}\x{305b}\x{3093}\x{3002}\n    \x{8868}\x{793a}\x{4e0a}\x{306e}\x{5927}\x{304d}\x{3055}\x{306f} CSS \x{3067}\x{6307}\x{5b9a}\x{3057}\x{3066}\x{304f}\x{3060}\x{3055}\x{3044}\x{3002}</dd>\n\n    </dl>\n  "
                                              },
                                      "message" => {
                                                   "en" => "The value is not a non-negative\n  integer",
                                                   "ja" => "\x{975e}\x{8ca0}\x{6574}\x{6570}\x{3067}\x{306f}\x{3042}\x{308a}\x{307e}\x{305b}\x{3093}"
                                                 }
                                    },
          "nninteger:zero" => {
                              "desc" => {
          ...
          "not IMT" => {
                       "desc" => {
                                 ...
                                 "ja" => "\n    <p>\x{6307}\x{5b9a}\x{3055}\x{308c}\x{305f}\x{5024}\x{306f} MIME \x{578b}\x{3067}\x{306f}\x{3042}\x{308a}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n\n    <p>Atom <code>content</code> \x{8981}\x{7d20}\x{306b}\n    <code>src</code> \x{5c5e}\x{6027}\x{304c}\x{3042}\x{308b}\x{3068}\x{304d}\x{306b}\x{306f}\x{3001} <code>type</code>\n    \x{5c5e}\x{6027}\x{5024}\x{306f} MIME \x{578b}\x{4ee5}\x{5916}\x{306e}\x{5024}\x{3067}\x{3042}\x{3063}\x{3066}\x{306f}\x{3044}\x{3051}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n  "
                               },
                       "message" => {
                                    "en" => "The value is not a MIME type",
                                    "ja" => "\x{3053}\x{306e}\x{5024}\x{306f} MIME \x{578b}\x{3067}\x{306f}\x{3042}\x{308a}\x{307e}\x{305b}\x{3093}"
                                  }
                     },
          "not boxable type" => {
                                "message" => {
          ...
          "ogp:bad property" => {
                                "desc" => {
                                          ...
                                          "ja" => "\n    <p><code>property</code> \x{5c5e}\x{6027}\x{5024}\x{306f} OGP \x{306e}\x{5c5e}\x{6027}\x{5024}\x{306e}\x{3044}\x{305a}\x{308c}\x{304b}\x{3067}\x{306a}\x{3051}\x{308c}\x{3070}\x{3044}\x{3051}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n  "
                                        },
                                "message" => {
                                             "en" => "The property name is invalid",
                                             "ja" => "\x{3053}\x{306e}\x{7279}\x{6027}\x{540d}\x{306f}\x{6b63}\x{3057}\x{304f}\x{3042}\x{308a}\x{307e}\x{305b}\x{3093}"
                                           }
                              },
          "ogp:enum:bad value" => {
                                  "desc" => {
                                            "en" => "\n    <p>The property of the element only allowes a limited set of\n    values.  One of them must be specified.</p>\n  ",
                                            "ja" => "\n    <p>\x{3053}\x{306e}\x{8981}\x{7d20}\x{306e}\x{7279}\x{6027}\x{306b}\x{306f}\x{6c7a}\x{3081}\x{3089}\x{308c}\x{305f}\x{5024}\x{3057}\x{304b}\x{4f7f}\x{3048}\x{307e}\x{305b}\x{3093}\x{3002}\x{6307}\x{5b9a}\x{3055}\x{308c}\x{3066}\x{3044}\x{308b}\x{5024}\x{306f}\x{8a8d}\x{3081}\x{3089}\x{308c}\x{305f}\x{5024}\x{3067}\x{306f}\x{3042}\x{308a}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n  "
                                          },
                                  "message" => {
                                               "en" => "The value is not one of allowed proeprty values",
                                               "ja" => "\x{3053}\x{306e}\x{5024}\x{306f}\x{8a8d}\x{3081}\x{3089}\x{308c}\x{3066}\x{3044}\x{308b}\x{7279}\x{6027}\x{5024}\x{3067}\x{306f}\x{3042}\x{308a}\x{307e}\x{305b}\x{3093}"
                                             }
                                },
          "ogp:missing prop" => {
                                "desc" => {
                                          "en" => "\n    <p>When OGP is used, when an OGP <code>og:type</code> is\n    specified, or when an OGP property is specified, an OGP property\n    might also have to be specified in the document.</p>\n  ",
                                          "ja" => "\n    <p>OGP \x{304c}\x{4f7f}\x{308f}\x{308c}\x{3066}\x{3044}\x{308b}\x{6642}\x{3084}\x{3042}\x{308b} OGP <code>og:type</code>\n    \x{304c}\x{4f7f}\x{308f}\x{308c}\x{3066}\x{3044}\x{308b}\x{6642}\x{3001}\x{3042}\x{308b} OGP \x{7279}\x{6027}\x{304c}\x{6307}\x{5b9a}\x{3055}\x{308c}\x{3066}\x{3044}\x{308b}\x{6642}\x{306b}\x{306f}\x{3001}\n    \x{7279}\x{5b9a}\x{306e} OGP \x{7279}\x{6027}\x{3082}\x{6587}\x{66f8}\x{4e2d}\x{306b}\x{6307}\x{5b9a}\x{3057}\x{3066}\x{304a}\x{304b}\x{306a}\x{3051}\x{308c}\x{3070}\x{3044}\x{3051}\x{306a}\x{3044}\x{3053}\x{3068}\x{304c}\x{3042}\x{308a}\x{307e}\x{3059}\x{3002}</p>\n  "
                                        },
                                "message" => {
                                             "en" => "Property <code><var>{text}</var></code>\n  is not specified in the document",
                                             "ja" => "\x{7279}\x{6027} <code><var>{text}</var></code>\n  \x{304c}\x{3053}\x{306e}\x{6587}\x{66f8}\x{306b}\x{306f}\x{6307}\x{5b9a}\x{3055}\x{308c}\x{3066}\x{3044}\x{307e}\x{305b}\x{3093}"
                                           }
                              },
          "ogp:og:type:bad value" => {
                                     "desc" => {
                                               "en" => "\n    <p>The <code>og:type</code> property value must be one of OGP type\n    values.</p>\n  ",
                                               "ja" => "\n    <p><code>og:type</code> \x{7279}\x{6027}\x{5024}\x{306f} OGP \x{306e}\x{578b}\x{306e}\x{3044}\x{305a}\x{308c}\x{304b}\x{3067}\x{306a}\x{3051}\x{308c}\x{3070}\x{3044}\x{3051}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n  "
                                             },
                                     "message" => {
                                                  "en" => "The <code>og:type</code> value is invalid",
                                                  "ja" => "\x{3053}\x{306e} <code>og:type</code> \x{5024}\x{306f}\x{6b63}\x{3057}\x{304f}\x{3042}\x{308a}\x{307e}\x{305b}\x{3093}"
                                                }
                                   },
          "ogp:og:type:private value" => {
                                         "desc" => {
                                                   "en" => "\n    <p>A private <code>og:type</code> property is used, which should\n    be avoided whenever possible for interoperability.</p>\n  ",
                                                   "ja" => "\n    <p>\x{79c1}\x{7684}\x{306a} <code>og:type</code> \x{7279}\x{6027}\x{5024}\x{304c}\x{4f7f}\x{308f}\x{308c}\x{3066}\x{3044}\x{307e}\x{3059}\x{304c}\x{3001}\n    \x{76f8}\x{4e92}\x{904b}\x{7528}\x{6027}\x{306e}\x{305f}\x{3081}\x{3001}\x{3067}\x{304d}\x{308b}\x{3060}\x{3051}\x{907f}\x{3051}\x{308b}\x{3079}\x{304d}\x{3067}\x{3059}\x{3002}</p>\n  "
                                                 },
                                         "message" => {
                                                      "en" => "A private <code>og:type</code> value is used",
                                                      "ja" => "\x{72ec}\x{81ea}\x{306e} <code>og:type</code> \x{5024}\x{304c}\x{4f7f}\x{308f}\x{308c}\x{3066}\x{3044}\x{307e}\x{3059}"
                                                    }
                                       },
          "ogp:private property" => {
                                    "desc" => {
                                              "en" => "\n    <p>A private property name is used, which should be avoided\n    whenever possible for interoperability.</p>\n  ",
                                              "ja" => "\n    <p>\x{79c1}\x{7684}\x{306a} \x{7279}\x{6027}\x{540d}\x{304c}\x{4f7f}\x{308f}\x{308c}\x{3066}\x{3044}\x{307e}\x{3059}\x{304c}\x{3001}\n    \x{76f8}\x{4e92}\x{904b}\x{7528}\x{6027}\x{306e}\x{305f}\x{3081}\x{3001}\x{3067}\x{304d}\x{308b}\x{3060}\x{3051}\x{907f}\x{3051}\x{308b}\x{3079}\x{304d}\x{3067}\x{3059}\x{3002}</p>\n  "
                                            },
                                    "message" => {
                                                 "en" => "A private property name is used",
                                                 "ja" => "\x{72ec}\x{81ea}\x{306e}\x{7279}\x{6027}\x{540d}\x{304c}\x{4f7f}\x{308f}\x{308c}\x{3066}\x{3044}\x{307e}\x{3059}"
                                               }
                                  },
          "ogp:prop:bad og:type" => {
                                    "desc" => {
                                              "en" => "\n    <p>Many OGP properties are only defined for specific sets of\n    <code>og:type</code> values.  Otherwise they cannot be used.</p>\n  ",
                                              "ja" => "\n    <p>\x{591a}\x{304f}\x{306e} OGP \x{7279}\x{6027}\x{306f}\x{7279}\x{5b9a}\x{306e} <code>og:type</code> \x{306e}\x{6642}\x{3060}\x{3051}\x{5b9a}\x{7fa9}\x{3055}\x{308c}\x{3066}\x{3044}\x{307e}\x{3059}\x{3002}\n    \x{305d}\x{308c}\x{4ee5}\x{5916}\x{306e}\x{6642}\x{306b}\x{306f}\x{4f7f}\x{3048}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n  "
                                            },
                                    "message" => {
                                                 "en" => "The property can only be specified\n  for a document with <code>og:type</code>\n  <code><var>{text}</var></code>",
                                                 "ja" => "\x{3053}\x{306e}\x{7279}\x{6027}\x{306f} <code>og:type</code>\n  <code><var>{text}</var></code> \x{306e}\x{6587}\x{66f8}\x{306b}\x{3057}\x{304b}\x{6307}\x{5b9a}\x{3067}\x{304d}\x{307e}\x{305b}\x{3093}"
                                               }
                                  },
          "ogp:prop:deprecated" => {
                                   "desc" => {
                                             "en" => "\n    <p>The OGP property is deprecated.  It should not be used.</p>\n  ",
                                             "ja" => "\n    <p>\x{3053}\x{306e} OGP \x{7279}\x{6027}\x{306f}\x{975e}\x{63a8}\x{5968}\x{3067}\x{3059}\x{3002}\x{4f7f}\x{3046}\x{3079}\x{304d}\x{3067}\x{306f}\x{3042}\x{308a}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n  "
                                           },
                                   "message" => {
                                                "en" => "The property is deprecated",
                                                "ja" => "\x{3053}\x{306e}\x{7279}\x{6027}\x{306f}\x{975e}\x{63a8}\x{5968}\x{3067}\x{3059}"
                                              }
                                 },
          "ogp:prop:duplicate" => {
                                  "desc" => {
                                            "en" => "\n    <p>The OGP property is already specified by another element.</p>\n  ",
                                            "ja" => "\n    <p>\x{3053}\x{306e} OGP \x{7279}\x{6027}\x{306f}\x{4ed6}\x{306e}\x{8981}\x{7d20}\x{306b}\x{3088}\x{308a}\x{65e2}\x{306b}\x{6307}\x{5b9a}\x{3055}\x{308c}\x{3066}\x{3044}\x{307e}\x{3059}\x{3002}</p>\n  "
                                          },
                                  "message" => {
                                               "en" => "The property is already specified",
          ...
          "pe not declared" => {
                               "desc" => {
                                         ...
                                         "ja" => "\n    <p>\x{5f15}\x{6570}\x{5b9f}\x{4f53}\x{306f}\x{3001}\x{5b9f}\x{4f53}\x{5ba3}\x{8a00}\x{306b}\x{3088}\x{3063}\x{3066}\x{5ba3}\x{8a00}\x{3055}\x{308c}\x{305f}\x{5f15}\x{6570}\x{5b9f}\x{4f53}\x{3092}\x{53c2}\x{7167}\x{3057}\x{306a}\x{3051}\x{308c}\x{3070}\x{3044}\x{3051}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n  "
                                       },
                               "message" => {
          ...
          "pi in pe in decl" => {
                                "desc" => {
                                          ...
                                          "ja" => "\n    <p>\x{30de}\x{30fc}\x{30af}\x{4ed8}\x{3051}\x{5ba3}\x{8a00}\x{5185} (\x{30ea}\x{30c6}\x{30e9}\x{30eb}\x{5916}) \x{304b}\x{3089}\x{53c2}\x{7167}\x{3055}\x{308c}\x{3066}\x{3044}\x{308b}\x{5916}\x{90e8}\x{5f15}\x{6570}\x{5b9f}\x{4f53}\x{3067}\x{306f}\x{51e6}\x{7406}\x{6307}\x{4ee4}\x{3092}\x{4f7f}\x{3063}\x{3066}\x{306f}\x{3044}\x{3051}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n  "
                                        },
                                "message" => {
                                             "en" => "There is a processing instruction in\n  an external entity referenced within a markup declaration",
                                             "ja" => "\x{30de}\x{30fc}\x{30af}\x{4ed8}\x{3051}\x{5ba3}\x{8a00}\x{5185}\x{304b}\x{3089}\x{53c2}\x{7167}\x{3055}\x{308c}\x{3066}\x{3044}\x{308b}\x{5916}\x{90e8}\x{5b9f}\x{4f53}\x{306b}\x{51e6}\x{7406}\x{6307}\x{4ee4}\x{304c}\x{3042}\x{308a}\x{307e}\x{3059}"
                                           }
                              },
          "pio" => {
                   "desc" => {
          ...
          "root text" => {
                         ...
                         "message" => {
                                      "en" => "The document cannot contain texts directly",
                                      "ja" => "\x{6587}\x{66f8}\x{306b}\x{76f4}\x{63a5}\x{30c6}\x{30ad}\x{30b9}\x{30c8}\x{3092}\x{542b}\x{3081}\x{308b}\x{3053}\x{3068}\x{306f}\x{3067}\x{304d}\x{307e}\x{305b}\x{3093}"
                                    }
                       },
          ...
          "xs:nonNegativeInteger:bad value" => {
                                               "desc" => {
                                                         ...
                                                         "ja" => "\n    <p>\x{5024}\x{306f}\x{975e}\x{8ca0}\x{6574}\x{6570}\x{3067}\x{306a}\x{3051}\x{308c}\x{3070}\x{3044}\x{3051}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n\n    <p>ASCII \x{6570}\x{5b57}1\x{6587}\x{5b57}\x{4ee5}\x{4e0a}\x{304b}\x{3001}\x{305d}\x{306e}\x{524d}\x{306b} <code>+</code> \x{7b26}\x{53f7}\x{3092}\x{3064}\x{3051}\x{305f}\x{3082}\x{306e}\x{304b}\x{3001}\n    <code>-</code> \x{7b26}\x{53f7}\x{306e}\x{3042}\x{3068}\x{306b} <code>0</code>\n    \x{3092}1\x{3064}\x{4ee5}\x{4e0a}\x{7d9a}\x{3051}\x{305f}\x{3082}\x{306e}\x{306e}\x{3044}\x{305a}\x{308c}\x{304b}\x{3067}\x{306a}\x{3051}\x{308c}\x{3070}\x{3044}\x{3051}\x{307e}\x{305b}\x{3093}\x{3002}</p>\n  "
                                                       },
                                               "message" => {
